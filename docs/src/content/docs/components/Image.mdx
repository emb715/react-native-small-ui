...
<PreviewFrame src="/example/showcase/components/image-avatar" height={240} />
...
<PreviewFrame src="/example/showcase/components/image-colormode" height={300} />
...
<PreviewFrame src="/example/showcase/components/image-platform" height={520} frame={true} />
