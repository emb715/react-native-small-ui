...
<PreviewFrame src="/example/showcase/components/button-basic" height={680} />
...
<PreviewFrame src="/example/showcase/components/button-slot-override" height={380} />
...
<PreviewFrame src="/example/showcase/components/button-platform-shadow" height={240} />
