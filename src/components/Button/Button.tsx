...
// } as const;
// // const getRootVarStyles2 = (mode: 'light' | 'dark') => {
// //   // mode === 'light' ? rootStyles : rootStylesDark;
// //   if (mode === 'dark') {
// //     return rootStylesDark as typeof rootStylesDark;
// //   }
// //   return rootStyles as typeof rootStyles;
// // };
...
// function getRootVarStyles2(mode: 'dark'): typeof rootStylesDark;
// function getRootVarStyles2(mode: 'light'): typeof rootStyles;
// function getRootVarStyles2(mode: any) {
//   if (mode === 'dark') {
//     return rootStylesDark;
//   }
//   return rootStyles;
...
// function asd(mode: 'light' | 'dark' = 'light') {
//   // const mode = 'light'
//   const qq =
//     mode === 'light' ? getRootVarStyles2('light') : getRootVarStyles2('dark');
//   return qq;
// }
...
// function getTextVariants2(mode: 'light' | 'dark') {
//   return {
//     primary: {
//       color: getRootVarStyles(mode)['--primary-foreground'],
//     },
//     secondary: {
//       color: getRootVarStyles(mode)['--secondary-foreground'],
//     },
//     destructive: {
//       color: getRootVarStyles(mode)['--destructive-foreground'],
//     },
//     outline: {
//       color: getRootVarStyles(mode)['--foreground'],
//     },
//     ghost: {
//       color: getRootVarStyles(mode)['--foreground'],
//     },
...
//       color: getRootVarStyles(mode)['--accent'],
//     },
//   } as const;
// }
// const getTextVariants = (mode: 'light' | 'dark') => ({
//   primary: {
//     color: getRootVarStyles(mode)['--primary-foreground'],
//   },
//   secondary: {
...
// const TextVariants2 = {
//   light: getTextVariants2('light'),
//   dark: getTextVariants2('dark'),
// };
// const TextVariants = {
//   light: {
//     primary: {
//       color:
//         getRootVarStyles2('light')['--primary-foreground'] ??
